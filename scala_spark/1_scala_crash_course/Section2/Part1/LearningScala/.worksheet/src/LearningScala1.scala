object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(127); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(316); 
  ...
  val singlePi: Double = 3.141592;System.out.println("""singlePi  : Double = """ + $show(singlePi ));$skip(36); 
  val doublePi: Double = singlePi*2;System.out.println("""doublePi  : Double = """ + $show(doublePi ));$skip(42); 
  println(f"Value of pi: $doublePi%.03f")}
