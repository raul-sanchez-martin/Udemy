object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(382); 
  ...
  // Then, do the same thing using a function literal instead of a separate, named function.
	...
	val myString: String = "foo";System.out.println("""myString  : String = """ + $show(myString ));$skip(34); ;
	println(myString.toUpperCase());$skip(66); ;
	
	

	
	def myUpperCase(x:String):String = {
		x.toUpperCase()
	};System.out.println("""myUpperCase: (x: String)String""");$skip(77); 
	
	
	def transformUpper(x:String, f: String => String): String = {
		f(x)
	};System.out.println("""transformUpper: (x: String, f: String => String)String""");$skip(37); val res$3 = 

	transformUpper("foo", myUpperCase);System.out.println("""res3: String = """ + $show(res$3));$skip(47); val res$4 = 
	
	transformUpper("foo", x => x.toUpperCase());System.out.println("""res4: String = """ + $show(res$4));$skip(23); val res$5 = 
	
  myUpperCase("foo");System.out.println("""res5: String = """ + $show(res$5))}
}
