object LearningScala1 {
  ...
  val singlePi: Double = 3.141592                 //> singlePi  : Double = 3.141592
  val doublePi: Double = singlePi*2               //> doublePi  : Double = 6.283184
  println(f"Value of pi: $doublePi%.03f")         //> Value of pi: 6.283
